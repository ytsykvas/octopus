...
export const uk: Translation = {
  ...
  project: {
    ...
    env: 'Файл env',
    envHint:
      'Записується у воркспейс як .env, якщо його там немає — при створенні й ще раз перед збіркою. Наявний файл ніколи не перезаписується. Доступний на читання лише вам.',
